...
const ForumEntryPage = async ({
  ...
  return (
    <div className='h-forum lg:overflow-hidden w-full flex items-start md:justify-center flex-col md:flex-row gap-4 p-2 md:p-4 lg:px-6'>
      ...
      <div className='bg-white w-full h-auto max-h-full p-2 md:px-4 rounded-md overflow-y-scroll'>
        ...
        <div className='space-y-2 md:space-y-6 h-auto max-h-full overflow-y-auto'>
          {
